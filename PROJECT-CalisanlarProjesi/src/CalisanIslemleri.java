...
public class CalisanIslemleri {
    ...
    public boolean girisYap(String kullanici_adi , String parola) {
        // Burada giriş yapılma durumu kontrol edilecek. Eğer Kullanıcı adı ve şifre eşleşirse true,
        // aksi halde false değer dönerek giriş durumu kontrol edilecektir.
    ...
    public CalisanIslemleri() {     // Burada bağlanma işlemleri gerçekleştirilecektşir.
