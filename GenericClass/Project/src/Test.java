...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n\t\t--- SINAV BİRİNCİSİ BULMA PROGRAMI ---");

        Scanner scanner = new Scanner (System.in);

        String islemler = "1) - İşlemleri Göster\n" +
                "2) - Eşit Ağırlık Öğrencileri Birincisi : \n" +
                "3) - Sayıasl Öğrencileri Birincisi : \n" +
        ...
        while (true) {
            ...
            // Birinci Öğrenci
            System.out.print("Birinci öğrenci adı : ");
            String isim1 = scanner.nextLine();

            System.out.print("Sınav netleri (Türkçe - Matematik - Edebiyat - Fizik ) : ");
            ...
            // İkinci Öğrenci
            System.out.print("İkinci öğrenci adı : ");
            ...
            // Üçüncü Öğrenci
            System.out.print("Üçüncü öğrenci adı : ");
            ...
            if (islem.equals("2")) {
                ...
                System.out.println("Öğrencin puanı : " + birinci.puanHesapla());
